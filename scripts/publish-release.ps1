...
- Fix window transparency (acrylic see-through, no 100% flicker)
...
$latestJson = @{
    version = $version
    notes = "- Fix window transparency (desktop see-through, no flicker at 100%)`n- Redesigned update screen with centered hero and release notes`n- Fix in-app updater manifest and check status"
